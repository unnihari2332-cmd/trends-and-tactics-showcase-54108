        ...
        <section className="px-6">
          <div className="container mx-auto max-w-6xl mt-10 mb-12">
            <div className="grid md:grid-cols-2 gap-8 items-center">
              ...
              >
                Social media platforms have become essential for businesses to
                connect with their target audience, build brand awareness, and
                drive customer engagement.{" "}
                <strong>Trends and Tactics</strong>, a leading social media
                marketing agency in Chennai, offers comprehensive services to
                help you leverage the power of social media to achieve your
                marketing goals.
              </motion.p>
            </div>
          </div>
