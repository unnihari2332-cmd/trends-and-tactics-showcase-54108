...
function NotFound() {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center text-center px-6 bg-white">
      <h1 className="text-4xl md:text-5xl font-bold mb-4 text-[#E05D35]">
        404 – Page Not Found
      </h1>
    ...
    <TooltipProvider>
      ...
      <BrowserRouter>
        ...
        <Routes>
          ...
          {/* Portfolio detail (existing) */}
          <Route
            path="/portfolio/the-indian-public-school"
            element={<TipsPortfolio />}
          />
          <Route
            path="/portfolio/luxe-jewelry-collection"
            element={<LuxeJewelry />}
          />
          ...
          <Route
            path="/portfolio/global-entertainment-hub"
            element={<Entertainment />}
          />
          <Route
            path="/portfolio/swathi-konde-actress"
            element={<SwathiKondePR />}
          />
          ...
          <Route
            ...
            element={<IstharaDining />}
          />
          {/* legacy / typo slugs for Isthara */}
          <Route
