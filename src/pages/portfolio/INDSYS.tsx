...
const heroBg = "/indsymain.jpg"; // 16:9 image in /public
              ...
              >
                ...
                <div className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
                  ...
                  <p className="text-gray-700 leading-relaxed">
                    Client-focused advisory for brand and digital
                    transformation—designed to educate, simplify decisions, and
                    grow results efficiently across web and social.
                  </p>
                </div>
                ...
                <div className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
                  ...
                  <p className="text-gray-700 leading-relaxed">
                    Brands today face declining online visibility and
                    inconsistent digital identities. Outdated websites and weak
                    branding limit engagement and growth. INDSYS helps
                    businesses overcome these challenges with creative design
                ...
                <div className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
                  ...
                  <p className="text-gray-700 leading-relaxed mb-4">
                    We blend creativity, technology, and strategy to deliver
                ...
                <div className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
                  ...
                  <div className="grid gap-4 grid-cols-1 sm:grid-cols-3 mb-4">
                    <div className="flex flex-col items-center rounded-xl bg-gray-50 border border-gray-200 p-5">
                      ...
                      <div className="text-xs text-gray-600 mt-2 text-center">
                        Increase in website visits (3 months)
                      </div>
                    </div>
                    <div className="flex flex-col items-center rounded-xl bg-gray-50 border border-gray-200 p-5">
                      <div className="text-3xl font-extrabold text-black">
                    ...
                    <div className="flex flex-col items-center rounded-xl bg-gray-50 border border-gray-200 p-5">
                      ...
                      <div className="text-xs text-gray-600 mt-2 text-center">
                        Boost in online table reservations
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="rounded-lg bg-gray-50 border border-gray-200 p-4">
                    <p className="text-sm text-gray-700 leading-relaxed">
                      Strengthened brand identity and recall through consistent
                      visual language, clearer messaging, and
                      performance-first web execution.
                    </p>
                  </div>
                </div>
                  ...
                  <div className="space-y-3">
                    <div className="flex items-start gap-3">
                      ...
                      <p className="text-gray-700 text-sm leading-relaxed">
                        Enhanced brand recognition with cohesive visual
                        identity system
                      </p>
                    </div>
                    <div className="flex items-start gap-3">
                    ...
                    <div className="flex items-start gap-3">
                      <div className="w-2 h-2 rounded-full bg-primary mt-2 flex-shrink-0"></div>
                      <p className="text-gray-700 text-sm leading-relaxed">
                        Increased organic search rankings with strategic SEO
                    ...
                    <div className="flex items-start gap-3">
                      <div className="w-2 h-2 rounded-full bg-primary mt-2 flex-shrink-0"></div>
                      <p className="text-gray-700 text-sm leading-relaxed">
                        Streamlined digital presence across all platforms with
